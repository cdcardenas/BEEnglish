 ...
 */
public class BEELoginActivity extends AppCompatActivity implements View.OnClickListener {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            //display some message here
                            Toast.makeText(BEELoginActivity.this,"Registration Error",Toast.LENGTH_LONG).show();
                        }
